...
public class VisitedRepositoryTest {
    ...
    public void saveAndGetByPubAndUserTest() {
        ...
        Optional<Visited> foundUVP = visitedRepository.findByPubAndVisitor(savedUVP.getPub(), savedUVP.getVisitor());
    ...
    private Visited saveVisit() {
        User user = userRepository.save(uvp.getVisitor());
        Pub pub = pubRepository.save(uvp.getPub());
        uvp.setVisitor(user);
        uvp.setPub(pub);

        return visitedRepository.save(uvp);
    }
